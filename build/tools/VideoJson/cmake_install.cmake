# Install script for directory: /home/alexchiluisac/PycharmProjects/P4-Visio/pangolin/tools/VideoJson
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/alexchiluisac/PycharmProjects/P4-Visio/pangolin/build/tools/VideoJson/VideoJsonPrint")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/alexchiluisac/PycharmProjects/P4-Visio/pangolin/build/tools/VideoJson/VideoJsonTransform")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform")
    if(CMAKE_INSTALL_DO_STRIP)
